import type { SnapshotMessage, DeltaMessage, PriceLevel } from "@/schemas/orderbook";

function applyLevels(book: Map<number, number>, levels: PriceLevel[]): Map<number, number> {
...
export function applyDelta(prev: OrderBookData, msg: DeltaMessage): DeltaResult {
